  ...
  <section id="about">
    <div className="row">
      ...
      <div className="nine columns main-col">
        ...
        <p>
          I've been working with technology since my teenage years when I bought my first computer at 15 with my paperboy money. I started with VS.net development in 2003, then grew tired of MS, learned Linux, open-source web development and have been doing it very successfully for many years now. I prefer to work remotely not on-site, since it's all internet based industry, it makes things easier on me. I'm very detail oriented and like to make things that are solid and scale beyond expectations. I love open-source, hot-pockets and kittens. <OutboundLink href="http://waterizlife.com">Ask me about the water that I drink and get you some!</OutboundLink> I don't need a degree to make secure, scalable applications. I mostly learn from others. I have real world production experience and that goes a long way compared to someone who only knows how to do what they're told and how to think. There's a good reason why I dropped out of school of indoctrination camps and I never looked back. I'm not some circus clown! When I am not working or learning some new technology, reading technical documentations or trying out tech stacks to see how they work and fit into an overall big picture; I like to seek the truth and do research about how the Earth is Flat, amongst other topics like conspiracies. I also like to read <OutboundLink href="https://top-secret-documents.com">top secret documents</OutboundLink> that have been declassified, and watch educational videos for fun. I highly recommend you read the <OutboundLink href="https://biblehub.com/kjv/" title="KJV is the only true word of God, the others newer versions are exoteric satanic versions, just FYI!">KJV Bible</OutboundLink>, or listen to the <OutboundLink href="https://soundcloud.com/search/sets?q=audiobible&filter.genre_or_tag=audiobooks">KJV Audio Bible</OutboundLink>.
        </p>
        <div className="row">
